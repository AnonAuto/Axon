...
(function(a) {
    ...
    a.each("email,url,number".split(","), function(b, c) {
    ...
    }, g.fn(":email", function(a, b) {
        if (!b || e.test(b)) {
            return true;
        }
        else {
            return $.localizeString("ETM.strings.please_enter_valid_email", "Please enter a valid email address.");
        }
    }), g.fn(":url", function(a, b) {
        if (!b || f.test(b)) {
            return true;
        }
        else {
            return $.localizeString("ETM.strings.please_enter_valid_URL", "Please enter a valid URL.");
        }
    }), g.fn(":number", function(a, b) {
        if (c.test(b)) {
            return true;
        }
        else {
            return $.localizeString("ETM.strings.please_enter_numeric", "Please enter a numeric value.");
        }
    }), g.fn("[max]", function(a, b) {
        ...
        if (parseFloat(b) <= parseFloat(c)) {
            ...
            var locString = $.localizeString("ETM.strings.please_enter_value_smaller", "Please enter a value smaller than ");
            locString += c;
            return locString;
        }
    }), g.fn("[min]", function(a, b) {
        if (b === "" || d && a.is(":date")) return !0;
        var c = a.attr("min");
        if (parseFloat(b) >= parseFloat(c)) {
            return !0;
            ...
            var locString = $.localizeString("ETM.strings.please_enter_value_larger", "Please enter a value larger than ");
            locString += c;
            return locString;
        }
    }), g.fn("[required]", function(a, b) {
        if (a.is(":checkbox")) return a.is(":checked");
        return (b.length > 0) ? true : $.localizeString("ETM.strings.please_complete_mandatory","Please complete this mandatory field.");
