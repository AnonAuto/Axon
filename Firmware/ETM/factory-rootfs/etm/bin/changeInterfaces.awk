#-------------------------------------------------
#
# @file changeInterfaces.awk
#
# TASER Data Classification: PUBLIC
#
# update the /etc/network/interfaces file as directed.
#
# This script is circulating on the internet, original
...
function usage() {
        print "awk -f changeInterfaces.awk <interfaces file> device=<eth device> \n" \
            ...
            "       [network=<ip addr>] [nameservers=<ip list> [mode=dhcp|static] [arg=debug]"
}
